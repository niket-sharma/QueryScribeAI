...
class QueryResponse(BaseModel):
    ...
    # RAG metadata
    tables_retrieved: Optional[int] = Field(None, description="Number of tables retrieved by Schema-Aware RAG")
    rag_enabled: bool = Field(False, description="Whether Schema-Aware RAG was used")
    
    # Self-correction metadata
    correction_attempts: int = Field(1, description="Number of correction attempts made")
    self_correction_applied: bool = Field(False, description="Whether self-correction loop was used")
    correction_history: Optional[list] = Field(None, description="History of correction attempts")
